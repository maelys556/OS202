...
if __name__ == "__main__":
    ...
    while True:
        if rank==0:
            ...
            (ants, pherom, food_counter) = MPI.pickle.loads(data)

            pherom.display(screen)

            screen.blit(mazeImg, (0, 0))
            ants.display(screen, sprites_ants)
            pg.display.update()
        ...
        if rank==1:
            ...
            data = MPI.pickle.dumps((ants, pherom,food_counter))
